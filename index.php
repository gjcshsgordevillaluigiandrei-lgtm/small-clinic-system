    ...
    <div class="container">
        ...
        <main>
            ...
            <?php if (isset($_GET['error'])): ?>
                <div class="alert error"><i class="fas fa-exclamation-circle"></i> <?php echo htmlspecialchars($_GET['error']); ?></div>
            <?php endif; ?>
            ...
            <div class="dashboard-stats">
                ...
                ?>
                <div class="stat-card"><h3><i class="fas fa-users"></i> Total Patients</h3><span class="stat-number"><?php echo $total_patients; ?></span></div>
                <div class="stat-card"><h3><i class="fas fa-calendar-times"></i> Pending Appointments</h3><span class="stat-number"><?php echo $pending_appointments; ?></span></div>
                <div class="stat-card"><h3><i class="fas fa-check-circle"></i> Cleared Today</h3><span class="stat-number"><?php echo $today_patients; ?></span></div>
                <div class="stat-card"><h3><i class="fas fa-dollar-sign"></i> Paid Patients</h3><span class="stat-number"><?php echo $cleared_patients; ?></span></div>
            </div>

            <!-- Quick Actions -->
            <div class="quick-actions">
                <a href="#patient-form" class="action-btn primary"><i class="fas fa-user-plus"></i> Register Patient</a>
                <a href="doctor_schedule.php" class="action-btn"><i class="fas fa-calendar-alt"></i> Doctor Schedules</a>
                ...
                <a href="payments.php" class="action-btn"><i class="fas fa-money-bill-wave"></i> Payments</a>
                <a href="medicine.php" class="action-btn"><i class="fas fa-pills"></i> Medicines</a>
                <a href="clearance.php" class="action-btn"><i class="fas fa-check-circle"></i> Clearance</a>
            </div>
            ...
            <div class="card">
                ...
                <form method="GET" action="clearance.php">
                    <div class="form-row">
                        ...
                        <button type="submit" class="btn primary">Check Records & Clearance</button>
                    </div>
                </form>
            </div>
                    ...
                    <tbody>
                        ...
                        while ($row = $stmt->fetch()) {
                            ...
                            echo "<tr>
                                ...
                                <td><a href='clearance.php?patient_id={$row['patient_id']}' class='btn primary'>View</a></td>
                            </tr>";
                        }
                        ?>
                    </tbody>
        ...
        <div class="modal-content">
            ...
            <form action="patient_register.php" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group"><label>Gender *</label><select name="gender" required><option value="">Select</option><option>Male</option><option>Female</option></select></div>
                </div>
                <div class="form-group"><label>Address *</label><textarea name="address" rows="3" required></textarea></div>
                <div class="form-group"><label>Contact Number *</label><input type="tel" name="contact_number" pattern="[0-9]{10,11}" required></div>
                <button type="submit" class="btn primary"><i class="fas fa-save"></i> Register Patient</button>
            </form>
        </div>
    </div>

    <!-- Appointment Modal (fixed availability) -->
    <div id="appointment-form" class="modal">
        <div class="modal-content">
            ...
            <form action="appointment_process.php" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group"><label>Date *</label><input type="date" name="appointment_date" id="appointment_date" required onchange="checkAvailability()"></div>
                    <div class="form-group"><label>Time *</label><input type="time" name="appointment_time" required></div>
                </div>
                <div class="form-group"><label>Laboratory Required?</label>
                    <select name="laboratory_required"><option value="">No</option><option value="Yes">Yes</option></select>
                </div>
                <div id="availability-status" style="margin: 10px 0; font-weight: bold;"></div>
                <button type="submit" class="btn primary" id="book-btn" disabled><i class="fas fa-calendar-check"></i> Book Appointment</button>
            </form>
        </div>
    </div>
